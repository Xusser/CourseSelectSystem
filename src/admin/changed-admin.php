...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
    ...
    // 构造查询
	$UpdateQuery = "UPDATE admin SET adminpassword=('$password') WHERE adminid=('$loginUsername')";
				...
				<div class="col-md-8">
					<form role="form" method="POST" action="<?php echo $editFormAction; ?>">
						<div class="form-group">
							...
							<label for="adminlabel1">
								管理员id
							</label>
							<input type="text" class="form-control" id="adminid" name="adminid" value="<?php echo $row_Recordset1['adminid']; ?>" readonly />
						</div>
						<div class="form-group">

							<label for="adminlabel2">
								管理密码
							</label>
							<input type="text" class="form-control" id="adminpassword" name="adminpassword" value="<?php echo $row_Recordset1['adminpassword']; ?>" />
						</div>
