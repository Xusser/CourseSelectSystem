...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
    ...
    // 构造查询
	$UpdateQuery = "UPDATE student SET stupassword=('$password') WHERE stuid=('$loginUsername')";
				...
				<div class="col-md-8">
					<form role="form" method="POST" action="<?php echo $editFormAction; ?>">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="stuid" name="stuid" value="<?php echo $_SESSION['MM_Username']; ?>" readonly="readonly" />
						</div>
						<div class="form-group">
							...
							<input type="text" class="form-control" id="stupassword" name="stupassword" value="<?php echo $row_Recordset1['stupassword']; ?>" />
						</div>
